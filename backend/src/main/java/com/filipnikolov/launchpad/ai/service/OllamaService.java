package com.filipnikolov.launchpad.ai.service;
...
public interface OllamaService {
     ...
     * @throws com.filipnikolov.launchpad.ai.exception.AiUnavailableException
     *         if Ollama is unreachable or returns an unexpected error
     * @throws com.filipnikolov.launchpad.ai.exception.AiNotReadyException

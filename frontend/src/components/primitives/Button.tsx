...
const VARIANT: Record<Variant, string> = {
  ...
  "solid-amber":
    "rounded-full border border-amber-300/30 bg-amber-500/20 px-4 py-2 text-sm font-medium text-amber-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] hover:bg-amber-500/25",
  icon:
